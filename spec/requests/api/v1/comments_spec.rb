...
#     before { get api_v1_article_comments_path, headers: headers }
#
...
#     it 'returns a successful response' do
#       get api_v1_article_comments_path,
#           params: create(:user),
#           headers: headers
#       expect(response).to be_successful
#     end
...
#         expect do
#           post api_v1_article_comments_path, params: { user: attributes_for(:user) }, headers: headers
...
#       before do
#         post api_v1_article_comments_path,
